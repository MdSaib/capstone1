const navUlmobile = document.querySelector('.navUlmobile');
...
performerButton.addEventListener('click', () => {
  document.querySelector('.performersGroup').innerHTML = '';
  ...
  for (let i = 0; i < stagePerformerLength; i++) {
    ...
    document.querySelector('.performersGroup').append(performer);
  }
});
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelector('.performersGroup').append(performerButton);
});
